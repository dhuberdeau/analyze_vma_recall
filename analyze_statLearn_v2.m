...
%% extraneous: plot those with perfect memory:
...
%         subplot(4,5,sub_plot_inds(i_grp, i_q)); hold on;
        
%         reach_var_0 = reach_var_0(sum(isnan(reach_var_0),2) < 1, :);
%         reach_var_1 = reach_var_1(sum(isnan(reach_var_1),2) < 1, :);
%         reach_var_2 = reach_var_2(sum(isnan(reach_var_2),2) < 1, :);
